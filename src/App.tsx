  ...
  return (
    <div data-theme={bgTheme} data-color-mode={colorMode} className="min-h-screen bg-transparent font-sans selection:bg-emerald-500 selection:text-white flex flex-col lg:flex-row relative">
      ...
      <div className="flex-1 flex flex-col">
        {/* Main View Area */}
        <main className="flex-1 lg:pl-64 pt-16 lg:pt-0 pb-8 min-h-screen w-full max-w-full overflow-x-hidden">
          <ErrorBoundary>
            <Routes>
        ...
        <footer className="w-full border-t border-white/10 bg-slate-950/70 text-slate-300 py-4 px-4 lg:px-8">
          <div className="max-w-7xl mx-auto flex flex-col items-center gap-2 text-center text-xs">
            <span>© {new Date().getFullYear()} ARAVINDAN VG SIMATS ENGINEERING • PROJECT 26</span>
            <span className="text-slate-400">Designed for calm focus, mindful flow, and a soothing digital sanctuary.</span>
          </div>
        </footer>
      </div>
